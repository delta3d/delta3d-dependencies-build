...
#define alutInit new_alutInit
#define alutInitWithoutContext new_alutInitWithoutContext
#define alutExit new_alutExit
...
#define alutLoadWAVFile new_alutLoadWAVFile
#define alutLoadWAVMemory new_alutLoadWAVMemory
#define alutUnloadWAV new_alutUnloadWAV
